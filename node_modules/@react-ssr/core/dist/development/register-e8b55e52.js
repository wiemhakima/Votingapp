...
var URLSafeBase64 = _interopDefault(require('urlsafe-base64'));
...
var getSsrConfig = function getSsrConfig() {
  ...
  var ssrConfigPath = path$1.join(cwd, 'ssr.config.js');
...
var getEngine = function getEngine() {
  return existsSync(path$1.join(cwd, 'tsconfig.json')) ? 'tsx' : 'jsx';
};
    ...
    return regenerator.wrap(function _callee$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return readdir(path$1.join(cwd, ssrConfig.viewsDir));
...
var getPageId = function getPageId(page) {
  ...
  var _page$replace$replace = page.replace(path$1.join(cwd, ssrConfig.viewsDir), '').replace(path$1.extname(page), '').split(path$1.sep),
...
var ignoreDotDir = function ignoreDotDir(file, stats) {
  ...
  return stats.isDirectory() && startsWith$2(_context4 = path$1.basename(file)).call(_context4, '.');
};

var ignoreNodeModules = function ignoreNodeModules(file, stats) {
  return stats.isDirectory() && path$1.basename(file) == 'node_modules';
};
    ...
    return regenerator.wrap(function _callee2$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            return _context6.abrupt("return", readdir(cwd, concat$2(_context5 = [ignoreNodeModules, ignoreDotDir]).call(_context5, ignores)));
...
var userDocumentPath = path$1.join(cwd$1, ssrConfig.viewsDir, "_document".concat(ext));
...
var userAppPath = path$1.join(cwd$1, ssrConfig.viewsDir, "_app".concat(ext));
var AppComponent;
    ...
    return regenerator.wrap(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            _context2.next = 5;
            return Promise.resolve().then(function () { return require('./antd-c164eb9e.js'); });
          ...
          case 7:
            _context2.next = 9;
            return Promise.resolve().then(function () { return require('./emotion-68f4c66f.js'); });
          ...
          case 11:
            _context2.next = 13;
            return Promise.resolve().then(function () { return require('./material-ui-d2c3c4ea.js'); });
          ...
          case 15:
            _context2.next = 17;
            return Promise.resolve().then(function () { return require('./styled-components-4337992d.js'); });
          ...
          case 19:
            _context2.next = 21;
            return Promise.resolve().then(function () { return require('./default-2a796bdc.js'); });
...
var compressProps = function compressProps(props) {
  ...
  var compressed = Buffer.from(LZString.compressToUint8Array(packed));
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            cachePath = path$1.join(cwd$1, ssrConfig.distDir, "".concat(pageId, ".html"));
            ...
            return _context5.abrupt("return", fse.readFileSync(cachePath).toString());
          ...
          case 9:
            ...
            html = (0, _context5.t0)( /*#__PURE__*/React.createElement(DocumentContext.Provider, {
              value: /*#__PURE__*/React.createElement(AppComponent, _extends_1({
                children: Page
              }, props))
            }, /*#__PURE__*/React.createElement(DocumentComponent, null)), pageId, compressProps(props));
          ...
          case 18:
            ...
            if (isProd() && !existsSync(cachePath)) {
              viewPath = slice$2(_context3 = slash(file.replace(path$1.join(cwd$1, ssrConfig.viewsDir), '').replace(ext, ''))).call(_context3, 1);

              if (includes$4(_context4 = ssrConfig.staticViews).call(_context4, viewPath)) {
                fse.outputFileSync(cachePath, html);
              }
            }
    ...
    return regenerator.wrap(function _callee2$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            renderFile = /*#__PURE__*/function () {
              var _ref2 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(file, options, cb) {
                var cacheablePages, pattern, settings, cache, _locals, props, _context;
                ...
                return regenerator.wrap(function _callee$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      ...
                      case 6:
                        settings = options.settings, cache = options.cache, _locals = options._locals, props = objectWithoutProperties(options, ["settings", "cache", "_locals"]);
                        _context2.prev = 7;
                        _context2.t0 = cb;
            ...
            _context3.next = 8;
            return Promise.resolve().then(function () { return require('./production-ca174304.js'); });
          ...
          case 12:
            _context3.next = 14;
            return Promise.resolve().then(function () { return require('./development-d5c99a56.js'); });
