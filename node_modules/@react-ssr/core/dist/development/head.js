...
var defaultHead = [/*#__PURE__*/React.createElement("meta", {
  charSet: "utf-8"
...
function onlyReactElement(list, child) {
  ...
  if (child.type === React.Fragment) {
    ...
    return concat$2(list).call(list, reduce$2(_context = React.Children.toArray(child.props.children)).call(_context, function (fragmentList, fragmentChild) {
...
function reduceComponents(headElements) {
  ...
  return map$2(_context5 = reverse$2(_context6 = filter$2(_context7 = concat$2(_context8 = reverse$2(_context9 = reduce$2(_context10 = reduce$2(headElements).call(headElements, function (list, headElement) {
    var headElementChildren = React.Children.toArray(headElement.props.children);
